...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L../bin/debug -L../vendor/math/debug
...
ifeq ($(config),fast)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L../bin/fast -L../vendor/math/fast -s -Ofast
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),dist)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L../bin/dist -L../vendor/math/dist -s -Ofast
  LINKCMD = $(CXX) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
